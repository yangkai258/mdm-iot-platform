...
**布局结构：**
1. 面包屑 → 页面标题
2. 筛选区（浅灰卡片 #F2F3F5）：状态 / 关键词搜索
3. 操作栏（新建公司靠左，批量导入/导出靠右）
4. 公司列表表格
...
**布局结构：**
1. 面包屑 → 页面标题
2. 筛选区（浅灰卡片）：公司 / 部门 / 在职状态 / 关键词
3. 操作栏（新建员工靠左，批量导入/导出靠右）
4. 员工列表表格
...
| 类型 | 使用场景 |
|------|----------|
| Drawer 抽屉 | 新建/编辑公司、部门、员工、岗位 |
| Dialog 对话框 | 删除确认、批量导入预览 |
| 全屏模态 | 暂无复杂表单场景 |
