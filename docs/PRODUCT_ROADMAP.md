...
**编制角色：** 产品经理 (agentcp)
**编制日期：** 2026-03-24
**文档状态：** 补充Sprint 21-32 PRD缺口，新增家庭相册AI筛选、宠物用品电商、Webhook市场、SDK发布PRD
...
| Webhook市场 | P2 | PRD_26_WEBHOOK_MARKET.md |
| SDK发布 | P2 | PRD_26_SDK_RELEASE.md |
...
| 宠物用品电商 | P3 | PRD_28_PET_SUPPLIES_ECOMMERCE.md |
...
| 家庭相册 | P2 | PRD_30_FAMILY_ALBUM.md |
