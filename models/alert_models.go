...
type DeviceAlertRule struct {
	...
	RuleType    string    `gorm:"type:varchar(50)" json:"rule_type"` // 规则类型
	...
	Conditions  JSON      `gorm:"type:jsonb" json:"conditions"` // 条件配置
	Actions     JSON      `gorm:"type:jsonb" json:"actions"`     // 动作配置
...
// AlertRule is an alias for DeviceAlertRule
...
// ToResponse converts DeviceAlertRule to AlertRuleResponse
