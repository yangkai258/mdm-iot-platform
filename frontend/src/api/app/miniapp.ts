...
export async function getHomeDevices(params = {}) {
  const res = await axios.get(`${BASE_URL}/home/devices`, { params, headers: headers() })
  return res.data
}
...
export async function controlDevice(id, data) {
  const res = await axios.post(`${BASE_URL}/devices/${id}/control`, data, { headers: headers() })
  return res.data
}

// ========== 语音指令 ==========
export async function sendVoiceCommand(id, data) {
  const res = await axios.post(`${BASE_URL}/devices/${id}/voice`, data, { headers: headers() })
  return res.data
}

// ========== 首页状态概览 ==========
export async function getHomeOverview() {
  const res = await axios.get(`${BASE_URL}/home/overview`, { headers: headers() })
  return res.data
}
