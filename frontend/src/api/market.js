...
export async function getEmoticonCategories() {
  return request(`${API_BASE}/emoticons/categories`)
}

/** 表情包列表 */
export async function getEmoticonList(params = {}) {
  const qs = new URLSearchParams(params).toString()
  return request(`${API_BASE}/emoticons?${qs}`)
}

/** 表情包详情 */
export async function getEmoticonDetail(id) {
  return request(`${API_BASE}/emoticons/${id}`)
}
...
export async function uploadEmoticon(data) {
  ...
  const res = await fetch(`${API_BASE}/emoticons`, {
    method: 'POST',
...
export async function deleteEmoticon(id) {
  return request(`${API_BASE}/emoticons/${id}`, { method: 'DELETE' })
}

/** 下载表情包 */
export async function downloadEmoticon(id) {
  return request(`${API_BASE}/emoticons/${id}/download`)
}
...
export async function getActionCategories() {
  return request(`${API_BASE}/actions/categories`)
}

/** 动作列表 */
export async function getActionList(params = {}) {
  const qs = new URLSearchParams(params).toString()
  return request(`${API_BASE}/actions?${qs}`)
}

/** 动作详情 */
export async function getActionDetail(id) {
  return request(`${API_BASE}/actions/${id}`)
}

/** 创建自定义动作 */
export async function createAction(data) {
  return request(`${API_BASE}/actions`, { method: 'POST', body: JSON.stringify(data) })
}

/** 更新动作 */
export async function updateAction(id, data) {
  return request(`${API_BASE}/actions/${id}`, { method: 'PUT', body: JSON.stringify(data) })
}

/** 删除动作 */
export async function deleteAction(id) {
  return request(`${API_BASE}/actions/${id}`, { method: 'DELETE' })
}

/** 发布动作到市场 */
export async function publishAction(id) {
  return request(`${API_BASE}/actions/${id}/publish`, { method: 'POST' })
}

/** 预览动作动画 */
export async function previewAction(id) {
  return request(`${API_BASE}/actions/${id}/preview`)
}
...
export async function getVoiceList(params = {}) {
  const qs = new URLSearchParams(params).toString()
  return request(`${API_BASE}/voices?${qs}`)
}

/** 声音详情 */
export async function getVoiceDetail(id) {
  return request(`${API_BASE}/voices/${id}`)
}

/** 创建声音配置 */
export async function createVoice(data) {
  return request(`${API_BASE}/voices`, { method: 'POST', body: JSON.stringify(data) })
}

/** 更新声音配置 */
export async function updateVoice(id, data) {
  return request(`${API_BASE}/voices/${id}`, { method: 'PUT', body: JSON.stringify(data) })
}

/** 删除声音配置 */
export async function deleteVoice(id) {
  return request(`${API_BASE}/voices/${id}`, { method: 'DELETE' })
}
