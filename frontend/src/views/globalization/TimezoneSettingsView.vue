...
const form = reactive({ keyword: '', timezone_name: '', timezone_code: '' })
const data = ref([])
...
const loadData = async () => {
  loading.value = true
  try {
    const res = await fetch('/api/v1/globalization/timezones', {
...
const openCreate = () => { isEdit.value = false; Object.assign(form, { timezone_name: '', timezone_code: '' }); formVisible.value = true }
