  ...
  children: [
    {
      ...
      meta: { locale: 'menu.members', title: '会员管理', requiresAuth: true, roles: ['*'] },
    },
    {
      path: 'devices',
      name: 'MdmDevices',
      component: () => import('@/views/DeviceList.vue'),
      meta: { locale: 'menu.devices', title: '设备列表', requiresAuth: true, roles: ['*'] },
    },
  ],
};
...
const ContentMarket: AppRouteRecordRaw = {
  ...
  meta: { locale: 'menu.content', requiresAuth: true, order: 21 },
  children: [
...
const OrgManagement: AppRouteRecordRaw = {
  ...
  meta: { locale: 'menu.org', requiresAuth: true, order: 50 },
  children: [
...
const PermissionManage: AppRouteRecordRaw = {
  ...
  meta: { locale: 'menu.permissionManage', requiresAuth: true, order: 60 },
  children: [
...
const MemberManage: AppRouteRecordRaw = {
  path: '/member', name: 'MemberManage',
  component: DEFAULT_LAYOUT, redirect: '/member/list',
  meta: { locale: 'menu.members', requiresAuth: true, order: 80 },
  children: [
...
const CouponManage: AppRouteRecordRaw = {
  ...
  meta: { locale: 'menu.members.coupon', requiresAuth: true, order: 110 },
  children: [
...
// ========== 岗位类型 ==========
const OccupationTypes: AppRouteRecordRaw = {
  path: '/occupation/types', name: 'OccupationTypes',
  component: () => import('@/views/members/OccupationTypesView.vue'),
  meta: { locale: 'menu.occupation.types', requiresAuth: true, order: 170 },
};

// ========== 签到记录 ==========
const SignInRecords: AppRouteRecordRaw = {
  path: '/signin/records', name: 'SignInRecords',
...
const TenantManage: AppRouteRecordRaw = {
  ...
  meta: { locale: 'menu.tenantManage', requiresAuth: true, order: 200 },
  children: [
...
const SystemManage: AppRouteRecordRaw = {
  ...
  meta: { locale: 'menu.system', requiresAuth: true, order: 210 },
  children: [
...
const SubscriptionManage: AppRouteRecordRaw = {
  ...
  meta: { locale: 'menu.subscriptionManage', requiresAuth: true, order: 220 },
  children: [
