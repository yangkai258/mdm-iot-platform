    ...
    >
      <a-form :model="formData" layout="vertical">
        ...
        <a-form-item field="icon" label="图标">
          <a-input v-model="formData.icon" placeholder="如 IconHome" />
        </a-form-item>
        <a-form-item field="path" label="路由路径">
          <a-input v-model="formData.path" placeholder="如 /system/menus" />
        </a-form-item>
        <a-form-item field="component" label="组件路径">
          <a-input v-model="formData.component" placeholder="如 /views/system/Menus.vue" />
        </a-form-item>
        <a-form-item field="permission" label="权限标识">
          <a-input v-model="formData.permission" placeholder="如 system:menu:view" />
        </a-form-item>
...
const toggleStatus = async (record) => {
  ...
  const data = await fetchApi(`/menus/${record.id}`, { method: 'PUT', body: JSON.stringify({ ...record, status: newStatus }) })
