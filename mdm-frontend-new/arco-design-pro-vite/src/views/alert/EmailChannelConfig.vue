<template>
  <Breadcrumb :items="['Home','Alert','EmailChannel','']" />
  <div class="page-container">
    <a-card class="general-card" title="邮件通知">
      <template #extra>
...
const columns = [
  ...
  { title: 'SMTP服务器', dataIndex: 'smtp_host', width: 160 },
  { title: '端口', dataIndex: 'smtp_port', width: 80 },
  { title: '发件人', dataIndex: 'from_address', width: 180 },
